...
if (DEFINED flatbuffers_SOURCE_DIR)
  # Ensure ORT's pinned FlatBuffers headers win over any system/ROCm copy.
  target_include_directories(onnxruntime_lora BEFORE PRIVATE ${flatbuffers_SOURCE_DIR}/include)
endif()
