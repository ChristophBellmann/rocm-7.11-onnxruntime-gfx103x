...
if (DEFINED flatbuffers_SOURCE_DIR)
  # Keep ORT-generated schema headers compatible by preferring pinned FlatBuffers.
  target_include_directories(onnxruntime_session BEFORE PRIVATE ${flatbuffers_SOURCE_DIR}/include)
endif()
